...
import co.edu.uptc.controller.StudentControl;//Student control
                                ...
                                for(int ic=0;ic<estudiantes.get(opcionEstu).getCalendarios().size();ic++)
                                {
                                    ...
                                    try {
                                        ...
                                        estudiantes.get(opcionEstu).getCalendarios().get(ic).setEventos(
                                                s1.inscribir(estudiantes.get(opcionEstu).getCalendarios().get(ic).getEventos()));
                            ...
                            case 2:
                                ...
                                for (int indexofCalendarios = 0; indexofCalendarios < tutors.get(opTut).getCalendarios().size(); indexofCalendarios++) {
                                    for (int i = 0; i < tutors.get(opTut).getCalendarios().get(indexofCalendarios).getEventos().size(); i++) {
                                        System.out.println((i + 1));
                                        System.out.println(tutors.get(opTut).getCalendarios().get(indexofCalendarios).showEvents());
